               ...
               <div className="">
                    <ul class="nav nav-tabs">
                        <li class="nav-item w-50 p-2">
                            <a class="nav-link text-center text-dark active fyd" aria-current="page" href="#">For Your Doughter</a>
                        </li>
                        <li class="nav-item w-50 p-2">
                            <a class="nav-link text-center text-dark bg-danger fys" aria-current="page" href="#">For Your Login</a>
                        </li>
                    </ul>
                </div> 
                ...
                <div>
                    ...
                    <div className="">
                        <a className="py-2 text-center" href="Registration">Create a new account </a>
                    </div>
            </div>
            </div>
            </div>
